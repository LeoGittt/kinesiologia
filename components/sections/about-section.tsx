...
export default function AboutSection() {
  ...
  return (
    <section id="nosotros" ref={ref} className="py-24 bg-[#F8F8F8]">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="text-2xl text-[#333333] font-semibold mb-6 text-center">
              "Creemos en el movimiento como terapia"
            </p>
            <p className="text-lg text-[#777777] leading-relaxed text-center">
