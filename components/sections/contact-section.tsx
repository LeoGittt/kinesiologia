...
export default function ContactSection() {
  ...
  return (
    <section id="contacto" ref={ref} className="py-24 bg-[#F8F8F8] dark:bg-gray-900">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <Link href="https://wa.me/5402645605270" target="_blank">
              <Card className="bg-white dark:bg-gray-800 border-0 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer">
                <CardContent className="p-8">
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#333333] dark:text-white mb-2">WhatsApp</h3>
              ...
              <Card className="bg-white dark:bg-gray-800 border-0 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer">
                <CardContent className="p-8">
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#333333] dark:text-white mb-2">Instagram</h3>
                      <p className="text-[#777777] dark:text-gray-300">
          ...
          >
            <Card className="bg-white dark:bg-gray-800 border-0 shadow-xl">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-[#333333] dark:text-white mb-6">Información de Contacto</h3>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#333333] dark:text-white mb-1">Dirección</h4>
                      <p className="text-[#777777] dark:text-gray-300">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#333333] dark:text-white mb-1">Horarios</h4>
                      <p className="text-[#777777] dark:text-gray-300">
