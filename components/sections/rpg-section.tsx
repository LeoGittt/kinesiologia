...
export default function RpgSection() {
  ...
  return (
    <section id="rpg" ref={ref} className="py-24 bg-white dark:bg-gray-950">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <p className="text-lg text-[#777777] dark:text-gray-300 leading-relaxed">
              ...
              <div className="bg-[#FFE8DF] dark:bg-[#FF6B35]/20 p-6 rounded-xl border-l-4 border-[#FF6B35]">
                <p className="text-[#333333] dark:text-white font-semibold text-lg mb-2">
              ...
              <p className="text-lg text-[#777777] dark:text-gray-300 leading-relaxed">
                ...
                calidad de vida. Además, es beneficiosa para prevenir lesiones y mejorar el rendimiento físico en
                deportistas.
              </p>
